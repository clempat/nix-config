  ...
  config = lib.mkIf cfg.enable {
    ...
    programs.plasma = {
      ...
      configFile = {
        ...
        "kactivitymanagerdrc"."activities"."bec65ecb-41e0-42bb-b894-26911f92bbe4" = "Default";
        "kactivitymanagerdrc"."main"."currentActivity" = "bec65ecb-41e0-42bb-b894-26911f92bbe4";
        ...
        "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{67a8ba83-35a4-4bc9-abf1-fd15638e74a4}";
        ...
        "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{cce9256e-725f-4903-b77a-a8716344ce3f}";
        ...
        "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{bfa11903-982d-4ae7-95b8-0ceccaa75db7}";
        ...
        "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{568fd003-71b5-43eb-b025-0e246144c848}";
        ...
        "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{24127656-3b7b-4367-92ff-2363c926f937}";
        ...
        "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{73412072-127c-4e8d-b5e5-74e79cbbaefa}";
        ...
        "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{589bb3de-c2f0-453a-b5a9-4f5783dacd45}";
        ...
        "kwinrc"."Desktops"."Id_1" = "b780c7cd-060c-4ac5-90d1-b4dcfd45842a";
