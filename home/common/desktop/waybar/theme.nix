{ config, lib, theme, ... }: {
  ...
  in {
    ...
    "#battery.charging" = { color = mkLiteral "${theme.colours.green}"; };
    ...
    "#temperature.critical" = { color = mkLiteral "${theme.colours.red}"; };

    "#bluetooth.off" = { color = mkLiteral "${theme.colours.orange}"; };

    "#wireplumber.muted" = { color = mkLiteral "${theme.colours.orange}"; };
