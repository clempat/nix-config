  ...
  xdg.configFile."aerospace/aerospace.toml" =
    let
      ...
      aerospace-settings = {
        ...
        on-window-detected = [
          {
            "if".app-name-regex-substring = "zen|arc|dia|firefox|brave|chromium|google-chrome";
            "if".window-title-regex-substring = "^(?!.*Picture-in-Picture).*$";
            run = [ "move-node-to-workspace 2" ];
          }
          {
            "if".app-name-regex-substring = "kitty|ghostty|alacritty|terminal|wezterm|warp";
        ...
        // (lib.lists.foldl' (
          ...
          // {
            ...
            "cmd-shift-${lib.strings.toLower letter}" = "move-node-to-workspace ${letter}";
          }
